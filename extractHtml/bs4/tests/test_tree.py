...
The tree traversal methods are the extracter advantage of using Beautiful
...
"""
    ...
    def test_tag_in_tag_many(self):
        for selector in ('html div', 'html body div', 'body div'):
            self.assertSelects(selector, ['extracter', 'inner', 'footer'])
    ...
    def test_a_bunch_of_emptys(self):
        for selector in ('div#extracter del', 'div#extracter div.oops', 'div div#extracter'):
    ...
    def test_select_on_element(self):
        ...
        # within the tree.
        inner = self.soup.find("div", id="extracter")
